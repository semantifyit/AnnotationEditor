...
exports.get = function (obj, selector) {
    return exports.pathStringToArr(selector).reduce(function (prev, cur) { return prev && prev[cur]; }, obj);
};
...
var setPath = function (obj, path, value) {
    var _a;
    var prop = path[0], rest = path.slice(1);
    if (path.length === 1) {
        if (Array.isArray(obj)) {
            if (exports.isNumeric(prop)) {
                ...
                if (obj.every(function (elem) { return typeof elem !== 'object'; })) {
...
exports.xmlToJson = function (xml) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2, new Promise(function (resolve, reject) {
                xml2js.parseString(xml, { explicitCharkey: true, trim: true }, function (err, result) {
                    if (err) {
                        reject(err);
                    }
                    resolve(result);
...
exports.parsePathStr = function (pathStr, keepDollar) {
    if (keepDollar === void 0) { keepDollar = false; }
    var _a = pathStr
        .trim()
        .split(/\|>/)
        .map(function (s) { return s.trim(); }), path = _a[0], transformFunction = _a[1];
    return {
