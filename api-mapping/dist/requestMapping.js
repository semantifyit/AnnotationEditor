...
var useInputValue = function (inputObj, pathStr, options) {
    var _a = util_1.parsePathStr(pathStr), path = _a.path, transformFunction = _a.transformFunction;
    var inputVal = util_1.get(inputObj, path);
    if (transformFunction && options.evalMethod) {
        return util_1.transFormValue(inputVal, transformFunction, options.evalMethod);
    }
    return inputVal;
};
...
exports.requestMapping = function (inputAction, userMapping, options) { return __awaiter(_this, void 0, void 0, function () {
    var userOptions, mapping, mappingType, _a, _b, e_1, _c, e_2, transformValue, newObj, path, queryString, url, mappingBody, evalCode, output;
        ...
        switch (_d.label) {
            ...
            case 12:
                try {
                    ...
                    newObj = util_1.removeUndef(util_1.deepMapValues(mapping, transformValue));
                    path = newObj.path && newObj.path.join('/');
                    queryString = newObj.query &&
